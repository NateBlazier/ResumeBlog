	...
	<div class="grid-container">
		...
		<a class="card clickable" href="/">
			<div class="image">
				...
				<div class="body">
					...
					<div class="footer">
							<div class="tags">
								<div class="tag primary">Front-End</div>
								<div class="tag primary">Svelte</div>
							</div>
					</div>
				</div>
		</a>
		...
		<a class="card clickable" href="/">
			<div class="image">
						...
						<img src="https://miro.medium.com/max/1400/1*wrRk5Ut1L7mmbaFLGELcIw.png" alt="Cover Image" loading="lazy" decoding="async" class="picture"> 
			</div>
				<div class="body">
		...
		<a class="card clickable" href="/">
			<div class="image">
						...
						<img src="https://miro.medium.com/max/1400/1*9PnPjPI65fGwLiMfluVLrw.jpeg" alt="Cover Image" loading="lazy" decoding="async" class="picture"> 
			</div>
				<div class="body">
		...
		<a class="card clickable" href="/">
			<div class="image">
						...
						<img src="https://blog.autify.com/static/0b1fa7c84cc543a52641d6395ad328c0/553fd/selenium-logo.png" alt="Cover Image" loading="lazy" decoding="async" class="picture"> 
			</div>
				<div class="body">
		...
		<a class="card clickable" href="/">
			<div class="image">
						...
						<img src="https://www.cloudsavvyit.com/p/uploads/2021/04/075c8694.jpeg" alt="Cover Image" loading="lazy" decoding="async" class="picture"> 
			</div>
				<div class="body">
