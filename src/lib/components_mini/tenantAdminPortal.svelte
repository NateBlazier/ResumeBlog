<script lang="ts">
  ...
  import type { ItenantAdminPortal } from '$lib/components_mini/miniData';
  export let oaTenantAdminPortal: ItenantAdminPortal;  
 
</script>

<Section header="Tenant Admin Portal">
  <div class="experience-list-container">    
    {#each oaTenantAdminPortal as {businesses} ()}
