...
<script lang="ts">
    ...
    import CreateNewTournamentForm from '$lib/components_mini/tournamentCreateNewForm.svelte';
...
import TournamentCreateNewForm from '$lib/components_mini/tournamentCreateNewForm.svelte';
  ...
  <Modal showModal={showModal} on:click={toggleModel}>
    <CreateNewTournamentForm on:addTournament={addTournament}/>
  </Modal>
  ...
  <div class="top-list">
    ...
    <div class="addNew-container">
      <button on:click={toggleModel} class="button">Add new tournament</button>
    </div>
  </div>
  
              <ul id='ulList' class="items-container" style="display: block;">
                {#each tournaments as {name, startDate, id} (id)}
                <a href={`tournaments/${id}`}>
                  <li class="item-container data-item_id={id}" style="display: block;">
                      ...
                      <div class= filterable-content>
                        ...
                        <div class="item-startDate">{startDate} </div>
                      </div>
